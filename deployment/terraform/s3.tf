# S3 Configuration for Static Assets and Backups
...
resource "aws_s3_bucket_lifecycle_configuration" "backups" {
  ...
  rule {
    ...
    expiration {
      days = var.backup_retention_days * 365  # Keep for multiple years
    }
...
resource "aws_cloudfront_distribution" "static_assets" {
  ...
  aliases = var.environment == "production" ? ["static.${var.domain_name}"] : []
  ...
  viewer_certificate {
    acm_certificate_arn      = var.environment == "production" ? aws_acm_certificate.cloudfront[0].arn : null
